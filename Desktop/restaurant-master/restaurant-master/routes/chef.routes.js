...
isAuthenticated = (req, res, next) => {
  if (req.isAuthenticated() && (req.user.isChef() || req.user.isAdmin()))
    return next();
...
router.post(
  ...
  [
    ...
    check("experience")
      .isLength({ min: 5 })
      .withMessage("experience should be more than 5 char"),
    check("type")
      .isLength({ min: 5 })
      .withMessage("type should be more than 5 char"),
    check("postcode")
      .isLength({ min: 5 })
      .withMessage("postcode should be more than 5 char"),
  ],
